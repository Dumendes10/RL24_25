...
plt.plot(rewards_q, alpha=0.3, label="Q-Learning")
plt.plot(rewards_dqn, alpha=0.3, label="DQN")
...
plt.hist(rewards_q[-50:], alpha=0.5, label="Q-Learning")
plt.hist(rewards_dqn[-50:], alpha=0.5, label="DQN")
plt.hist(rewards_ppo[-50:], alpha=0.5, label="PPO")
plt.hist(rewards_a2c[-50:], alpha=0.5, label="A2C")
